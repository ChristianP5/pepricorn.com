...
<!-- HOME PAGE REDIRECT -->
                <li>
                    <a href="../views/hero.php" class="hover:text-blue-600 transition duration-250 ease-in" id="about-us">Home</a>
                </li>
<!-- -->
                <li>
                    <a href="mailto:01082210021@student.uph.edu?subject=New%20chat%20message"
                        class="hover:text-blue-600 transition duration-250 ease-in" id="contact-us">Contact us</a>
                </li>
                <li>
        ...
        <nav class="container lg:mt-4">
            <ul class="grid grid-cols-12 lg:flex lg:justify-between w-full gap-x-8 items-center">
 ...
 <!-- -->
                    <li>
                        <div class="flex lg:py-2 lg:px-3 rounded-lg bg-gray-100">
                            ...
                            <img src="../public/img/search.png" class="w-3 h-3 mt-3 ml-2 mr-2">
                            <!-- SEARCH BAR START -->
                ...
                <div class="col-span-5 items-center lg:hidden">
                    <div class="flex gap-x-4">
                        ...
                        <img onclick="toggleSlideover()" src="../public/img/shopping-cart (1).png"
                            class="w-5 h-5 max-w-full max-h-full">
                ...
                <!-- <div class="col-span-5 mt-2 flex items-center">
                    <img src="img/location-pin (2).png" class="w-3 h-3" />
                            ...
                            <div class="px-5">
                                <div class="flex justify-between items-center mt-5">
                                    ...
                                    <div onclick="toggleSlideover()"
                                        class="cursor-pointer text-gray-600 top-0 w-8 h-8 flex items-center justify-center right-0">
                    ...
                    <div id="slideover2"
                        ...
                        <div class="flex h-full flex-col justify-between overflow-y-scroll">
                            <div class="px-5">
                                ...
                                <div
                                    class="mt-2 flex items-center justify-between w-full border border-gray-300 rounded-lg py-2 px-4">
                                ...
                                <div
                                    class="mt-2 flex items-center justify-between w-full border border-gray-300 rounded-lg py-2 px-4">
                                    <img src="img/shop-follow.svg" alt="" srcset="">
                                    <p>Status belanjaanmu nanti bisa dicek di sini, <br> lho!</p>
                                </div>
                ...
                <div class="hidden lg:flex gap-x-4 lg:gap-x-4 items-center">
                    <a href=""><img src="../public/img/shopping-cart.png" class="w-5 h-5 max-w-full max-h-full mr-2" /></a>
                    <a href=""><img src="../public/img/bell (1).png" class="w-5 h-5 max-w-full max-h-full mr-2" /></a>
                    <a href=""><img src="../public/img/email (1).png" class="w-5 h-5 max-w-full max-h-full" /></a>
                </div>
                <div class="hidden lg:flex gap-x-4 place-self-end items-center">
                    <?php
                    if($user_image_name == ""){
                        ?>
                        <img src="../images/user/default.png" class="w-10 rounded-full cursor-pointer">
                        <?php
                    }else{
                        ?>
                        <a href="profile.php?id=<?php echo $user_id;?>">
                        <img src="../images/user/<?php echo $user_image_name;?>" class="w-10 rounded-full cursor-pointer">
                        </a>
                        <?php
                    }
                    ?>
    ...
    <div class="hidden lg:flex justify-between items-center px-16 py-4">
        <div class="flex items-center cursor-pointer">
            <div class="flex items-center justify-center">
                ...
                <!-- Dropdown menu -->
                <div id="dropdown"
                    class="absolute mt-[28rem] z-10 hidden w-56 p-3 bg-white border-2 border-gray-200 rounded-lg shadow-md">
