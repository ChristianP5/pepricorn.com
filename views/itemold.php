...
?>
    ...
    <body class="text-xs">
        <?php include('partials/navbar.php') ?>
            <div class="lg:h-screen mb-16 overflow-hidden px-4 md:px-8 lg:px-16">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#"
                                            class="ml-1 lg:text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 transition duration-250 ease-in"><?php echo $product_store_name;?></a>
                                    </div>
                                </li>
                    ...
                    <div class="grid grid-cols-1 lg:flex mt-4 gap-x-16">
                        ...
                        if($display_product_images_count>0){
                            while($display_product_images_rows = mysqli_fetch_assoc($display_product_images_res)){
                                ...
                                ?>
                                    <img src="../images/product/<?php echo $display_product_images_image_name; ?>" class="rounded-lg lg:w-1/3 aspect-square object-cover">
                                <?php
                            }
                        }else{
                            $display_product_images_image_name = "default.png";
...
<!-- Content End-->
                    <div>
                        <div class="mt-8 lg:mt-16 bg-white py-4 px-4 rounded-lg text-base shadow-xl">
                            ...
                            <div class="flex justify-between mt-4 items-center">
                                ...
                                <p class="font-bold text-xl" id="total-price"><?php echo $product_data_price;?></p>
                            </div>
                            <button
                                class="w-full py-4 rounded-lg bg-blue-600 text-white font-semibold mt-4 border-2 border-blue-600 hover:bg-blue-800 hover:border-blue-800 transition duration-250 ease-in">Add
                                to cart</button>
                        </div>
        ...
        <section class="bg-gray-50 mt-16 px-4 py-8 lg:py-16">
