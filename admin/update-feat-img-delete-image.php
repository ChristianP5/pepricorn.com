...
<?php
    if(isset($_GET['image_name'])&&isset($_GET['id'])){
        ...
        $sql = "SELECT * FROM tbl_featuredimages WHERE id=$id AND image_name='$image_name'";
        ...
        if($count == 1){
            ...
            $delete_path = "../images/featured/".$image_name;
            ...
            if($remove_image==FALSE){
                ...
                header('location:'.SITEURL.'admin/update-feat-img.php?id='.$id);
                die();
            }else{
                $image_name = "";
            }
